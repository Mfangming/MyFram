...
public class DateUtils {
	...
	public static Date toDate_(String dateFormat) {
		...
		try {
			Date newDate = myFmt.parse(dateFormat);
			return newDate;
	...
	/**
	 * yyyy-MM-dd HH:mm:ss 格式转换为 yyyy-MM-dd HH:mm
	 *
	 * @param date
	 * @return
	 */
	...
	public static String SubToH(String str) {
		if (null != str && !"".equals(str)) {
			...
			String H = str.split(" ").length > 1 ? str.split(" ")[1] : str;
			String time = H.split(":").length > 1 ? H.split(":")[0] + "时" : H;
	 ...
	 * 截取时间
	 *
	 * @return yyyy年MM月dd日 11/11/11 00:00:00
	 */
	...
	/**
	 * 将"yyyy-MM-dd HH:mm:ss"转换成"yyyy年MM月dd日"
	 *
	 * @param time
	 * @return
	 */
